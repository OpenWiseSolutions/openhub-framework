  ...
  render () {
    ...
    return (
      <div style={computedStyles}>
        ...
        <Item icon={<MdHome />} style={styles.item} label='Item 1' />
        <Item icon={<MdImportantDevices />} style={styles.item} label='Item 2' />
        <Item icon={<MdChart />} style={styles.item} label='Item 3' />
        <Item icon={<MdInsertInvitation />} style={styles.item} label='Item 4'>
          <Item icon={<MdChart />} style={styles.nestedItem} label='Nested item' />
        </Item>
